    ...
    chapters: [
      {
        ...
        questions: [
          {
            id: 1,
            question: 'A car accelerates from rest to 72 km/h in 10 seconds. What is its acceleration?',
            options: ['1 m/s²', '2 m/s²', '4 m/s²', '5 m/s²'],
            correctAnswer: '2 m/s²',
            explanation: 'Convert 72 km/h → 20 m/s. Using a = (v - u)/t = (20 - 0)/10 = 2 m/s²',
            difficulty: 'Easy',
          },
          {
            id: 2,
            question: 'A ball is thrown vertically upward with a velocity of 20 m/s. How high does it go? (g = 10 m/s²)',
          ...
          {
            id: 3,
            question: 'What is the range of a projectile launched at 45° with initial speed 20 m/s?',
          ...
          {
            id: 4,
            question: 'A train travels 150 km in 3 hours. What is its average speed in m/s?',
          ...
          {
            id: 5,
            question: 'A stone is dropped from a height of 80 m. How long does it take to reach the ground? (g = 10 m/s²)',
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            explanation: 'For every force exerted by object A on object B, B exerts an equal and opposite force on A.',
            difficulty: 'Easy',
          },
          {
            id: 3,
            question: 'A 30 N force is applied on a box but 10 N friction opposes it. What is the net force?',
          ...
          {
            id: 4,
            question: 'What is the weight of a 60 kg person on Earth? (g = 9.8 m/s²)',
        ...
        questions: [
          {
            ...
            explanation: 'ΔU = Q - W, where ΔU is change in internal energy, Q is heat added, W is work done by system.',
            difficulty: 'Easy',
          },
          {
            id: 2,
            ...
            explanation: 'The Kelvin is the base SI unit for thermodynamic temperature. 0 K is absolute zero.',
            difficulty: 'Easy',
          },
          {
            id: 3,
          ...
          },
          {
            ...
            options: ['Pressure decreases', 'Pressure stays the same', 'Pressure increases', 'Volume increases'],
            correctAnswer: 'Pressure increases',
            explanation: "By Gay-Lussac's Law, P ∝ T at constant volume. Higher temp = faster molecules = higher pressure.",
            difficulty: 'Medium',
          },
        ],
      },
        ...
        questions: [
          {
            ...
            explanation: 'The speed of light c = 299,792,458 m/s ≈ 3 × 10⁸ m/s. It is a universal constant.',
            difficulty: 'Easy',
          },
          {
            id: 2,
          ...
          },
          {
            ...
            explanation: 'Sound waves are longitudinal — particle displacement is parallel to wave propagation direction.',
            difficulty: 'Easy',
          },
          {
            id: 4,
            question: 'What is the refractive index if light slows from 3×10⁸ to 2×10⁸ m/s?',
        ...
        questions: [
          {
            ...
            explanation: 'The modern periodic table has 118 confirmed elements, from Hydrogen (1) to Oganesson (118).',
            difficulty: 'Easy',
          },
          {
            id: 2,
            ...
            options: ['4', '6', '8', '12'],
            correctAnswer: '6',
            explanation: 'Carbon (C) has 6 protons, so its atomic number is 6. It is in Period 2, Group 14.',
            difficulty: 'Easy',
          },
          {
            id: 3,
            question: 'Which is the most electronegative element?',
            options: ['Oxygen (O)', 'Chlorine (Cl)', 'Nitrogen (N)', 'Fluorine (F)'],
            correctAnswer: 'Fluorine (F)',
            explanation: 'Fluorine has an electronegativity of 3.98 on the Pauling scale — the highest of all elements.',
            difficulty: 'Medium',
          },
          {
            id: 4,
            ...
            explanation: 'Argon (Ar, atomic number 18) is the noble gas in Period 3 of the periodic table.',
            difficulty: 'Easy',
          },
          {
            id: 5,
            ...
            explanation: 'Group 1 elements (Li, Na, K, Rb, Cs, Fr) are alkali metals — very reactive, single valence electron.',
            difficulty: 'Easy',
          },
        ],
      },
        ...
        questions: [
          {
            ...
            explanation: 'Na donates an electron to Cl, creating Na⁺ and Cl⁻ ions attracted by electrostatic forces.',
            difficulty: 'Easy',
          },
          {
            id: 2,
            ...
            explanation: 'Carbon has 4 valence electrons and needs 4 more to complete its octet, forming 4 covalent bonds.',
            difficulty: 'Easy',
          },
          {
            id: 3,
            ...
            correctAnswer: 'A weak attraction between H and electronegative atoms (N, O, F)',
            explanation: 'Hydrogen bonds form when H bonded to N/O/F is attracted to lone pairs on another N/O/F atom.',
            difficulty: 'Medium',
          },
          {
            id: 4,
            question: 'What is the shape of a water molecule?',
            options: ['Linear (180°)', 'Trigonal planar (120°)', 'Tetrahedral (109.5°)', 'Bent / V-shaped (104.5°)'],
            correctAnswer: 'Bent / V-shaped (104.5°)',
            explanation: 'Water has 2 bonding pairs and 2 lone pairs on O. Lone pairs repel, bending the angle to 104.5°.',
            difficulty: 'Medium',
          },
        ],
      },
        ...
        questions: [
          {
            ...
            options: ['0', '5', '7', '14'],
            correctAnswer: '7',
            explanation: 'Pure water is neutral — [H⁺] = [OH⁻] = 10⁻⁷ mol/L, so pH = -log(10⁻⁷) = 7.',
            difficulty: 'Easy',
          },
          {
            id: 2,
            question: 'What are the products of an acid-base neutralization?',
            options: ['Acid and water', 'Salt and water', 'Base and gas', 'Oxide and water'],
            correctAnswer: 'Salt and water',
            explanation: 'Acid + Base → Salt + Water. E.g., HCl + NaOH → NaCl + H₂O',
            difficulty: 'Easy',
          },
          {
            id: 3,
            question: 'Which is a stronger acid: HCl or CH₃COOH?',
            options: ['CH₃COOH', 'HCl', 'They are equal', 'Depends on concentration'],
            correctAnswer: 'HCl',
            explanation: 'HCl is a strong acid — fully dissociates in water. Acetic acid (CH₃COOH) is a weak acid.',
            difficulty: 'Medium',
          },
          {
            id: 4,
            question: 'How does a Brønsted-Lowry acid behave?',
            options: ['Accepts a proton (H⁺)', 'Donates a proton (H⁺)', 'Donates an electron pair', 'Accepts an electron pair'],
            correctAnswer: 'Donates a proton (H⁺)',
            explanation: 'In Brønsted-Lowry theory, an acid donates H⁺ to a base. The base accepts the proton.',
            difficulty: 'Medium',
          },
          {
            id: 5,
            ...
            correctAnswer: 'Red',
            explanation: 'Litmus paper turns red below pH 7 (acidic) and blue above pH 7 (basic).',
            difficulty: 'Easy',
          },
        ],
      },
        ...
        questions: [
          {
            ...
            correctAnswer: 'CₙH₂ₙ₊₂',
            explanation: 'Alkanes are saturated hydrocarbons. E.g., methane CH₄ (n=1), ethane C₂H₆ (n=2).',
            difficulty: 'Easy',
          },
          {
            id: 2,
            question: 'What functional group defines alcohols?',
            options: ['Carbonyl group (C=O)', 'Carboxyl group (-COOH)', 'Hydroxyl group (-OH)', 'Amino group (-NH₂)'],
            correctAnswer: 'Hydroxyl group (-OH)',
            explanation: 'Alcohols contain the -OH group. E.g., methanol CH₃OH, ethanol C₂H₅OH.',
            difficulty: 'Easy',
          },
          {
            id: 3,
            ...
            correctAnswer: 'Compounds with the same formula but different structures',
            explanation: 'E.g., butane and isobutane both have formula C₄H₁₀ but different structures.',
            difficulty: 'Medium',
          },
          {
            id: 4,
            question: 'Name the simplest aromatic compound.',
            options: ['Methane (CH₄)', 'Ethylene (C₂H₄)', 'Acetylene (C₂H₂)', 'Benzene (C₆H₆)'],
            correctAnswer: 'Benzene (C₆H₆)',
            explanation: 'Benzene is a cyclic compound with 6 carbons and delocalized π electrons, making it aromatic.',
            difficulty: 'Medium',
          },
        ],
      },
    ...
    chapters: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            options: ['(x - 3)²', '(x + 9)(x - 1)', '(x + 3)(x - 3)', '(x - 3)(x - 3)'],
        ...
        questions: [
          {
            ...
            correctAnswer: '180°',
            explanation: 'All triangles, regardless of type, have interior angles summing to exactly 180°.',
            difficulty: 'Easy',
          },
          {
            id: 2,
          ...
          {
            id: 3,
            question: 'In a right triangle, legs are 3 cm and 4 cm. Find the hypotenuse.',
          ...
          },
          {
            ...
            correctAnswer: '30 cm',
            explanation: 'A regular hexagon has 6 equal sides. Perimeter = 6 × 5 = 30 cm',
            difficulty: 'Easy',
          },
        ],
      },
        ...
        questions: [
          {
            ...
            options: ["f'(x) = 3x² + 8", "f'(x) = 3x² + 8x", "f'(x) = x² + 8x", "f'(x) = 3x + 8x"],
          ...
          },
          {
            ...
            correctAnswer: 'cos(x)',
            explanation: 'd/dx[sin(x)] = cos(x). This is a standard trigonometric derivative.',
            difficulty: 'Easy',
          },
          {
            id: 3,
            ...
            correctAnswer: 'x² + C',
            explanation: '∫2x dx = 2 × x²/2 + C = x² + C. Always add constant of integration C.',
            difficulty: 'Easy',
          },
          {
            id: 4,
            ...
            correctAnswer: '1',
            explanation: 'This is a standard limit: lim(x→0) sin(x)/x = 1. Proved by the squeeze theorem.',
            difficulty: 'Hard',
          },
        ],
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            correctAnswer: '1/2',
            explanation: 'A fair coin has 2 equal outcomes (H, T). P(H) = 1/2 = 0.5 = 50%.',
            difficulty: 'Easy',
          },
          {
            id: 3,
          ...
          },
          {
            ...
            explanation: 'A low SD means data is clustered near the mean; a high SD means data is more spread out.',
            difficulty: 'Medium',
          },
        ],
      },
